...
Route::post('/clients/{id}/reserve', [ClientController::class, 'reserve'])->name('clients.reserve');
...
// Route pour lister les clients (accessible uniquement aux utilisateurs authentifiés)
Route::middleware('auth')->group(function () {
